...
gcc -c -m00 -ffreestanding -nostdlib -Wall -Wextra src/kernel/main.c -o build/kernel.o # change -m00 to -m32 or -m64 (depends on your device and architecture)
ld -T linker.ld -m XXXX -o build/kernel.tmp build/kernel.o # change XXXX to your emulation mode. (i386pe, i386pep, i386linux, elf_i386, elf32_x86_64)
